...
# further edited by team YBIGTA for KPMG competition
...
def recognize_facial_expression(image, on_gpu, face_detection_method, grad_cam, user_image_enc, face_coordinates:List[Tuple]):
    """
    ...
    if face_coordinates is None:
        ...
        for face_coordinate in face_coordinates:
            face = image[face_coordinate[0]-10:face_coordinate[2]+10, face_coordinate[3]-10:face_coordinate[1]+10]
        ...
        to_return_fer = FER(image, face, face_coordinate, emotion, affect, saliency_maps)
